      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3 md:gap-6">
          <template v-if="isPortalInvestidor">
            ...
            <a
              href="https://darkturquoise-parrot-843561.hostingersite.com"
              target="_blank"
              class="flex items-center gap-3 bg-amber-500 hover:bg-white text-black px-5 py-2.5 rounded-xl transition-all duration-300 shadow-lg shadow-amber-500/20 group"
            >
    ...
    >
      <div v-if="isMobileMenuOpen" class="fixed inset-0 bg-zinc-950 min-h-screen z-[105] lg:hidden flex flex-col p-8 pt-32">
        <nav class="flex flex-col gap-6">
          <a v-for="item in currentLinks" :key="item.href" :href="item.href" @click="isMobileMenuOpen = false" class="text-2xl font-black uppercase tracking-tighter text-white border-b border-white/5 pb-4 italic">
            {{ item.label }}
          </a>

          <router-link
            v-if="!isPortalInvestidor"
            to="/portal-investidor"
            @click="isMobileMenuOpen = false"
            class="text-2xl font-black uppercase tracking-tighter text-amber-500 flex items-center gap-3 italic"
          >
          ...
          <router-link
            ...
            to="/"
            @click="isMobileMenuOpen = false"
            class="text-2xl font-black uppercase tracking-tighter text-green-500 flex items-center gap-3 italic"
          >
        ...
        <div class="mt-auto pb-10">
          <a
            :href="isPortalInvestidor ? 'https://darkturquoise-parrot-843561.hostingersite.com' : 'https://wa.me/5579999094631?text=Olá!+Gostaria+de+reservar+um+veículo.'"
            target="_blank"
